...
class SubmitRdvEntity extends EditorialContentEntityBase implements SubmitRdvEntityInterface {
  ...
  public static function baseFieldDefinitions(EntityTypeInterface $entity_type) {
    ...
    $fields['user_id'] = BaseFieldDefinition::create('entity_reference')
      ...
      ->setDescription(t('The user ID of author of the Submit rdv entity entity.'))
    ...
    $fields['name'] = BaseFieldDefinition::create('string')
      ->setLabel(t('Name'))
      ->setDescription(t('The name of the Submit rdv entity entity.'))
      ->setRevisionable(TRUE)
      ->setSettings([
        'max_length' => 50,
        'text_processing' => 0,
    ...
    $fields['status']->setDescription(t('A boolean indicating whether the Submit rdv entity is published.'))
      ->setDisplayOptions('form', [
